package javaProblemSolvingWithSoftware.week4;
...
public class BabyNames {
    ...
    public void whatIsNameInYear(String name, int year, int newYear, String gender) {
        FileResource fr = new FileResource("/home/anujb/IdeaProjects/java-assignments/src/javaProblemSolvingWithSoftware/week4/us_babynames_test/yob" + year + "short.csv");
        FileResource newFr = new FileResource("/home/anujb/IdeaProjects/java-assignments/src/javaProblemSolvingWithSoftware/week4/us_babynames_test/yob" + newYear + "short.csv");
    ...
    public void testTotlaBirth() {
        FileResource fr = new FileResource("/home/anujb/IdeaProjects/java-assignments/src/javaProblemSolvingWithSoftware/week4/us_babynames_by_decade/yob1900s.csv");
        totalBirths(fr);
